...
data "archive_file" "fixture" {
  type                    = "zip"
  output_path             = "${path.module}/cspm-aws-2024-0546.zip"
...
resource "aws_iam_role" "fixture" {
  ...
  name  = "cspm-aws-2024-0546-lambda-role"
...
resource "aws_lambda_function" "fixture" {
  count            = var.allow_unsafe_apply ? 1 : 0
  function_name    = "cspm-aws-2024-0546-fixture"
...
resource "aws_lambda_permission" "public_administration" {
  count         = var.allow_unsafe_apply ? 1 : 0
